...
export default function BlogRoute() {
  return (
    <div className="min-h-screen bg-[var(--color-bg-base)] text-slate-700 dark:text-slate-300 overflow-x-hidden selection:bg-violet-500/30 dark:selection:text-white pb-24">
